...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('new_pay', function (Blueprint $table) {
            ...
            $table->string('user_params',1000)->nullable(true); 
            $table->integer('request_text_id')->nullable(true); 
